(ns kaleidoscope.clj.http-api.wedding
  (:require [amazonica.aws.s3 :as s3]
            [amazonica.core :as amazon]
            [kaleidoscope.clj.api.authorization :as auth]
            [kaleidoscope.clj.http-api.album :as album-routes]
            [kaleidoscope.clj.http-api.cache-control :as cc]
            [kaleidoscope.clj.http-api.photo :as photo-routes]
            [kaleidoscope.clj.http-api.ping :refer [ping-routes]]
            [kaleidoscope.clj.http-api.swagger :as swagger]
