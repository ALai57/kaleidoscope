...
# key, and ANTHROPIC_API_KEY (required — the generated fly.toml inherits prod's
# llm scorer/workflow-executor/claude-vision-transcriber config unchanged). Also
# (optionally) the Auth0 M2M creds used by the smoke test, and (optionally)
