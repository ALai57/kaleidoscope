...
(deftest environment->launch-options-parsing-test
  (testing "Happy path"
    (are [expected environment]
      ...
      {:database {:db-type :embedded-h2}} {"ANDREWSLAI_DB_TYPE" "embedded-h2"}
  ...
  (testing "Invalid options"
    (is (thrown-with-msg? clojure.lang.ExceptionInfo
                          #"Invalid log level. Set via ANDREWSLAI_LOG_LEVEL environment variable."
                          (sut/environment->launch-options {"ANDREWSLAI_LOG_LEVEL" "invalid-level"})))))
