...
ALTER TABLE projects ADD COLUMN IF NOT EXISTS hostname VARCHAR;
...
ALTER TABLE workflows ADD COLUMN IF NOT EXISTS hostname VARCHAR;
...
ALTER TABLE score_definitions ADD COLUMN IF NOT EXISTS hostname VARCHAR;
...
ALTER TABLE agent_definitions ADD COLUMN IF NOT EXISTS hostname VARCHAR;
...
ALTER TABLE user_workspace_roots ADD COLUMN IF NOT EXISTS hostname VARCHAR;
...
ALTER TABLE interests ADD COLUMN IF NOT EXISTS hostname VARCHAR;
...
ALTER TABLE workflow_steps ADD COLUMN IF NOT EXISTS hostname VARCHAR;
...
ALTER TABLE project_workflow_runs ADD COLUMN IF NOT EXISTS hostname VARCHAR;
...
ALTER TABLE project_workflow_step_runs ADD COLUMN IF NOT EXISTS hostname VARCHAR;
...
ALTER TABLE project_score_runs ADD COLUMN IF NOT EXISTS hostname VARCHAR;
...
ALTER TABLE project_score_dimensions ADD COLUMN IF NOT EXISTS hostname VARCHAR;
...
ALTER TABLE score_dimension_definitions ADD COLUMN IF NOT EXISTS hostname VARCHAR;
...
ALTER TABLE project_notes ADD COLUMN IF NOT EXISTS hostname VARCHAR;
...
ALTER TABLE project_conversations ADD COLUMN IF NOT EXISTS hostname VARCHAR;
...
ALTER TABLE project_skills ADD COLUMN IF NOT EXISTS hostname VARCHAR;
...
ALTER TABLE workflow_rounds ADD COLUMN IF NOT EXISTS hostname VARCHAR;
...
ALTER TABLE workflow_judge_records ADD COLUMN IF NOT EXISTS hostname VARCHAR;
...
ALTER TABLE project_briefs ADD COLUMN IF NOT EXISTS hostname VARCHAR;
...
ALTER TABLE project_task_generation_runs ADD COLUMN IF NOT EXISTS hostname VARCHAR;
...
ALTER TABLE project_tasks ADD COLUMN IF NOT EXISTS hostname VARCHAR;
...
ALTER TABLE task_artifacts ADD COLUMN IF NOT EXISTS hostname VARCHAR;
...
ALTER TABLE recommendations ADD COLUMN IF NOT EXISTS hostname VARCHAR;
